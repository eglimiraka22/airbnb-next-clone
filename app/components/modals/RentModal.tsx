...
const RentModal = () => {
  ...
  if (step === STEPS.IMAGES) {
    bodyContent = (
      ...
      <ImageUpload value={imageSrc} onChange={(value) => setCostumValue('imageSrc' , value) } />
      </div>
    )
  ...
  if (step === STEPS.PRICE) {
    bodyContent = (
      <div className=" flex flex-col gap-8">
        <Heading title="Now , set your price"  subtitle="How much do you charge for night"/>
