...
const SearchModal = () => {
    ...
    const onSubmit = useCallback(async () => {
       ...
       setStep(STEPS.LOCATION)
         searchModal.onClose()
            router.push(url)
    }, [bathroomCount, dateRange, guestCount, location?.value, onNext, params, roomCount, router, searchModal, step])
    ...
    let bodyContent = (
        <div className='flex flex-col gap-8'>
            <Heading title='Where are you going?' subtitle='Find perfect location' />
    ...
    if (step === STEPS.DATE) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                <Heading title='Select the date' subtitle='Make sure everyone is free' />
    ...
    if (step === STEPS.INFO) {
        bodyContent = (
            <div className='flex flex-col gap-8'>
                <Heading title='More information?' subtitle='Make sure everyone is comfortable' />
